...
ALTER TABLE "prime_tests" ADD "test_mcma_partial_score" Boolean NOT NULL Default '1';
ALTER TABLE "prime_tests" ADD "test_logout_on_timeout" Boolean NOT NULL Default '0';
