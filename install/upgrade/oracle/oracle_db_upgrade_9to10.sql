...
ALTER TABLE prime_tests ADD test_mcma_partial_score NUMBER(1) DEFAULT '1' NOT NULL;
ALTER TABLE prime_tests ADD test_logout_on_timeout Boolean NUMBER(1) DEFAULT '0' NOT NULL;
