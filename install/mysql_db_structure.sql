...
ALTER TABLE prime_users ADD UNIQUE ak_user_name (user_name);
ALTER TABLE prime_users ADD UNIQUE ak_user_regnumber (user_regnumber);
ALTER TABLE prime_users ADD UNIQUE ak_user_passport (user_passport);
...
ALTER TABLE prime_tests ADD UNIQUE ak_test_name (test_name);
ALTER TABLE prime_tests_users ADD UNIQUE ak_testuser (testuser_test_id,testuser_user_id,testuser_status);
ALTER TABLE prime_tests_logs ADD UNIQUE ak_testuser_question (testlog_testuser_id,testlog_question_id);
...
ALTER TABLE prime_tests_users ADD Foreign Key (testuser_user_id) references prime_users (user_id) ON DELETE cascade ON UPDATE no action;
ALTER TABLE prime_tests ADD Foreign Key (test_user_id) references prime_users (user_id) ON DELETE cascade ON UPDATE no action;
...
ALTER TABLE prime_subjects ADD Foreign Key (subject_user_id) references prime_users (user_id) ON DELETE cascade ON UPDATE no action;
...
ALTER TABLE prime_usrgroups ADD Foreign Key (usrgrp_user_id) references prime_users (user_id) ON DELETE cascade ON UPDATE no action;
ALTER TABLE prime_questions ADD Foreign Key (question_subject_id) references prime_subjects (subject_id) ON DELETE cascade ON UPDATE no action;
ALTER TABLE prime_test_subjects ADD Foreign Key (subjset_subject_id) references prime_subjects (subject_id) ON DELETE restrict ON UPDATE no action;
ALTER TABLE prime_answers ADD Foreign Key (answer_question_id) references prime_questions (question_id) ON DELETE cascade ON UPDATE no action;
ALTER TABLE prime_tests_logs ADD Foreign Key (testlog_question_id) references prime_questions (question_id) ON DELETE restrict ON UPDATE no action;
ALTER TABLE prime_tests_logs_answers ADD Foreign Key (logansw_answer_id) references prime_answers (answer_id) ON DELETE restrict ON UPDATE no action;
ALTER TABLE prime_tests_users ADD Foreign Key (testuser_test_id) references prime_tests (test_id) ON DELETE cascade ON UPDATE restrict;
ALTER TABLE prime_testgroups ADD Foreign Key (tstgrp_test_id) references prime_tests (test_id) ON DELETE cascade ON UPDATE no action;
ALTER TABLE prime_test_subject_set ADD Foreign Key (tsubset_test_id) references prime_tests (test_id) ON DELETE cascade ON UPDATE no action;
ALTER TABLE prime_tests_logs ADD Foreign Key (testlog_testuser_id) references prime_tests_users (testuser_id) ON DELETE cascade ON UPDATE no action;
ALTER TABLE prime_tests_logs_answers ADD Foreign Key (logansw_testlog_id) references prime_tests_logs (testlog_id) ON DELETE cascade ON UPDATE no action;
ALTER TABLE prime_usrgroups ADD Foreign Key (usrgrp_group_id) references prime_user_groups (group_id) ON DELETE cascade ON UPDATE no action;
ALTER TABLE prime_testgroups ADD Foreign Key (tstgrp_group_id) references prime_user_groups (group_id) ON DELETE cascade ON UPDATE no action;
ALTER TABLE prime_test_subjects ADD Foreign Key (subjset_tsubset_id) references prime_test_subject_set (tsubset_id) ON DELETE cascade ON UPDATE no action;
