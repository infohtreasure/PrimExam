 ...
 * WARNING: primexam trusts CAS mechanism and replicates any authenticated user into the primexam database. Passwords are set to the username string, therefore, primexam authentication is not secure for replicated users if CAS Authentication is turned off again.
 ...
 * This is the primexam group ID to which the CAS accounts belongs.
