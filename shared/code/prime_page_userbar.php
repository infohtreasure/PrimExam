<?php
//============================================================+
// File name   : prime_page_userbar.php
// Begin       : 2004-04-24
...
if ($_SESSION['session_user_level'] > 0) {
	...
	// display logout link
	echo ' <a href="prime_logout.php" class="logoutbutton" title="'.$l['h_logout_link'].'">'.$l['w_logout'].'</a>'.K_NEWLINE;
} else {
	// display login link
	echo ' <a href="prime_login.php" class="loginbutton" title="'.$l['h_login_button'].'">'.$l['w_login'].'</a>'.K_NEWLINE;
}
echo '</div>'.K_NEWLINE;

// language selector
if (K_LANGUAGE_SELECTOR AND (stristr($_SERVER['SCRIPT_NAME'], 'prime_test_execute.php') === FALSE)) {
	echo '<div class="minibutton" dir="ltr">'.K_NEWLINE;
...
//echo '<a><b>Primexam</b></a> ver. '.K_primeXAM_VERSION.' - Copyright &copy; 2010-2015 - <b>Hidden Treasure Computers Ltd</b>';
echo '<span class="copyright">&copy; www.htreasure.com</span>';
echo '</div>'.K_NEWLINE;
