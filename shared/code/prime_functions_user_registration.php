<?php
//============================================================+
// File name   : prime_functions_user_registration.php
// Begin       : 2008-03-31
...
function F_send_user_reg_email($user_id, $user_email, $user_verifycode) {
	...
	require_once('../../shared/config/prime_email_config.php');
	require_once('../../shared/config/prime_user_registration.php');
	require_once('../../shared/code/prime_functions_html2txt.php');
	...
	$subscribe_url = ''.K_PATH_PUBLIC_CODE.'prime_user_verification.php?a='.$user_email.'&amp;b='.$user_verifycode.'&amp;c='.$user_id.'';
	...
	$mail->Body = str_replace('#primeXAMURL#', K_PATH_HOST.K_PATH_primeXAM, $mail->Body);
