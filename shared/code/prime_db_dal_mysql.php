<?php
//============================================================+
// File name   : prime_db_dal_mysql.php
// Begin       : 2003-10-12
// Last Update : 2014-03-31
//
// Description : MySQL driver for primexam Database Abstraction
//               Layer (DAL).
...
/**
 * @file
 * MySQL driver for primexam Database Abstraction Layer (DAL).
 ...
 */
function F_db_connect($host = '', $port = '', $username = '', $password = '', $database = '') {
