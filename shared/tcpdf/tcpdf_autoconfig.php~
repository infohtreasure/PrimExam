...
// Authors     : Ifeoluwa Opeyemi O - Hidden Tresure Computers Ltd - www.htreasure.com - info@htreasure.com
// License     : GNU-LGPL v3 (http://www.gnu.org/copyleft/lesser.html)
// -------------------------------------------------------------------
// Copyright (C) 2011-2014 Ifeoluwa Opeyemi O - Hidden Tresure Computers Ltd
//
...
if (!defined('PDF_HEADER_STRING')) {
	define ('PDF_HEADER_STRING', "by Ifeoluwa Opeyemi O - htreasure.com\nwww.tcpdf.org");
}
