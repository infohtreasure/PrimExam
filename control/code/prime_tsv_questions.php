<?php
//============================================================+
// File name   : prime_tsv_questions.php
// Begin       : 2006-03-06
...
if ((isset($_REQUEST['expmode']) AND ($_REQUEST['expmode'] > 0))
	...
	switch ($expmode) {
		case 1: {
			$tsv_filename = 'primexam_subject_'.$subject_id.'_'.date('YmdHi').'.tsv';
			break;
		}
		case 2: {
			$tsv_filename = 'primexam_module_'.$module_id.'_'.date('YmdHi').'.tsv';
			break;
		}
		case 3: {
			$tsv_filename = 'primexam_all_modules_'.date('YmdHi').'.tsv';
			break;
		}
		default: {
			$tsv_filename = 'primexam_export_'.date('YmdHi').'.tsv';
			break;
		}
	}
