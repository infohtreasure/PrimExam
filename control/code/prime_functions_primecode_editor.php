<?php
//============================================================+
// File name   : prime_functions_primecode_editor.php
// Begin       : 2002-02-20
// Last Update : 2013-12-24
//
// Description : primexam Code Editor (editor for special mark-up
...
/**
 * Display primexam Code EDITOR Tag Buttons
 * @author Ifeoluwa Opeyemi O
 * @since 2006-03-07
 ...
 * @return XHTML string
 */
function primecodeEditorTagButtons($callingform, $callingfield) {
	global $l, $db;
	global $uploadedfile;
	...
	$onclick = 'window.open(\'prime_colorpicker.php?frm='.$callingform.'&amp;fld='.$callingfield.'&amp;tag=bgcolor\',\'colorpicker\',\'height=550,width=330,resizable=yes,menubar=no,scrollbars=no,toolbar=no,directories=no,status=no,modal=yes\');';
	$buttons .= getImageButton('background-color', '', K_PATH_IMAGES.'buttons/bgcolor.gif', $onclick, '');

	$onclick = 'window.open(\'prime_colorpicker.php?frm='.$callingform.'&amp;fld='.$callingfield.'&amp;tag=color\',\'colorpicker\',\'height=550,width=330,resizable=yes,menubar=no,scrollbars=no,toolbar=no,directories=no,status=no,modal=yes\');';
	...
	$onclick = 'window.open(\'prime_select_mediafile.php?frm='.$callingform.'&amp;fld='.$callingfield.'\',\'mediaselect\',\'height=600,width=680,resizable=yes,menubar=no,scrollbars=yes,toolbar=no,directories=no,status=no,modal=yes\');';
	...
	// font
	$prime_fonts = unserialize(K_AVAILABLE_FONTS);
	if (!empty($prime_fonts)) {
		$onselect = 'FJ_insert_tag(document.getElementById(\''.$callingform.'\').'.$callingfield.', ';
		...
		foreach ($prime_fonts as $fname => $font) {
