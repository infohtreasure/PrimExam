<?php
//============================================================+
// File name   : prime_page_info.php
// Begin       : 2004-05-21
// Last Update : 2014-03-04
//
// Description : Outputs primexam information page.
//
...
/**
 * @file
 * Outputs primexam information page.
...
echo ''.$l['d_primexam_desc'].'<br />'.K_NEWLINE;

echo '<ul class="credits">'.K_NEWLINE;
echo '<li><strong>'.$l['w_author'].':</strong> Ifeoluwa Opeyemi O</li>'.K_NEWLINE;
echo '<li><strong>Copyright:</strong><br /> (c) 2004-2014 Ifeoluwa Opeyemi O - htreasure.com LTD<br />'.K_NEWLINE;
echo '<a href="mailto:info@htreasure.com">info@htreasure.com</a> - '.K_NEWLINE;
echo '<a href="http://www.htreasure.com" title="'.$l['m_new_window_link'].'">www.htreasure.com</a></li>'.K_NEWLINE;
...
echo '<p>primexam includes some third-party software components that are not striclty required but have been included as you convenience, and if used are subject to their respective licenses.</p>'.K_NEWLINE;
...
primexam includes fonts for the <a href="http://www.tcpdf.org" title="TCPDF - PHP class for PDF">TCPDF</a> library, they are not striclty required but have been included as you convenience.<br />
<br />
...
echo '<li>[EN] English : Ifeoluwa Opeyemi O</li>'.K_NEWLINE;
...
echo '<li>[IT] Italian : Ifeoluwa Opeyemi O</li>'.K_NEWLINE;
...
echo '<a href="http://www.primexam.org/license.php"><img src="../../images/credits/agplv3-88x31.png" alt="primexam License" width="88" height="31" style="border:none;" /></a>'.K_NEWLINE;
