<?php
//============================================================+
// File name   : prime_xml_results.php
// Begin       : 2008-06-06
...
$out_filename = 'primexam_results_'.date('YmdHis').'_test_'.$test_id;
...
function F_xml_export_results($test_id, $group_id=0, $user_id=0, $startdate=0, $enddate=0, $display_mode=1) {
	...
	$xml .= '<primexamresults version="'.K_primeXAM_VERSION.'">'.K_NEWLINE;
	$xml .=  K_TAB.'<header';
