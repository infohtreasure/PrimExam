<?php
//============================================================+
// File name   : prime_show_result_user.php
// Begin       : 2004-06-10
...
if (isset($teststat) AND !empty($teststat)) {
	...
	echo getFormDescriptionLine($l['w_comment'].':', $l['h_testcomment'], F_decode_primecode($teststat['testinfo']['user_comment']));
	...
	if (($test_id > 0) AND ($user_id > 0) AND ($testuser_id > 0)) {
		...
		echo '<br /><br />';
		echo '<a href="prime_pdf_results.php?mode=3'.$filter.'" class="xmlbutton" title="'.$l['h_pdf'].'">'.$l['w_pdf'].'</a> ';
		echo '<a href="prime_email_results.php?mode=1&amp;menu_mode=startlongprocess'.$filter.'" class="xmlbutton" title="'.$l['h_email_result'].'">'.$l['w_email_result'].'</a> ';
		echo '<a href="prime_email_results.php?mode=0&amp;menu_mode=startlongprocess'.$filter.'" class="xmlbutton" title="'.$l['h_email_result'].' + PDF">'.$l['w_email_result'].' + PDF</a> ';
	}
