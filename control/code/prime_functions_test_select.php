<?php
//============================================================+
// File name   : prime_functions_test_select.php
// Begin       : 2012-12-02
	...
	if ($r = F_db_query($sql, $db)) {
		if ($m = F_db_fetch_array($r)) {
			...
			do {
				...
				echo '<td style="text-align:'.$txtalign.';">&nbsp;<a href="prime_edit_test.php?test_id='.$m['test_id'].'" title="'.$l['w_edit'].'">'.htmlspecialchars($m['test_name'], ENT_NOQUOTES, $l['a_meta_charset']).'</a></td>'.K_NEWLINE;
