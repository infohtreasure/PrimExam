<?php
//============================================================+
// File name   : prime_xml_questions.php
// Begin       : 2006-03-06
...
if ((isset($_REQUEST['expmode']) AND ($_REQUEST['expmode'] > 0))
	...
	switch ($expmode) {
		case 1: {
			$out_filename = 'primexam_subject_'.$subject_id;
			break;
		}
		case 2: {
			$out_filename = 'primexam_module_'.$module_id;
			break;
		}
		case 3: {
			$out_filename = 'primexam_all_modules';
			break;
		}
		default: {
			$out_filename = 'primexam_export';
			break;
		}
	}
...
function F_xml_export_questions($module_id, $subject_id, $expmode) {
	...
	$xml .= '<primexamquestions version="'.K_primexam_VERSION.'">'.K_NEWLINE;
	$xml .=  K_TAB.'<header';
	...
	$xml .= K_TAB.'</body>'.K_NEWLINE;
	$xml .= '</primexamquestions>'.K_NEWLINE;
