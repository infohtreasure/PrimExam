<?php
//============================================================+
// File name   : prime_xml_user_results.php
// Begin       : 2008-12-26
...
$out_filename = 'primexam_user_results_'.$user_id.'_'.date('YmdHis');
...
function F_xml_export_user_results($user_id, $startdate, $enddate, $order_field) {
	...
	$xml .= '<primexamuserresults version="'.K_primexam_VERSION.'">'.K_NEWLINE;
	$xml .=  K_TAB.'<header';
	...
	$xml .= K_TAB.'</body>'.K_NEWLINE;
	$xml .= '</primexamuserresults>'.K_NEWLINE;
