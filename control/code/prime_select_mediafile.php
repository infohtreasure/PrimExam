<?php
//============================================================+
// File name   : prime_select_mediafile.php
// Begin       : 2010-09-20
...
require_once('prime_functions_filemanager.php');
...
if (!empty($file)) {
	...
	$w = 500;
	$h = 250;
	echo F_objects_replacement($filedata['primename'], $filedata['extension'], 0, 0, $l['w_preview'], $w, $h);
	echo '<br />'.K_NEWLINE;
	// display basic info
	...
	// action buttons
	echo '<input type="hidden" name="file" id="file" value="'.$file.'" />'.K_NEWLINE;
	echo '<input type="hidden" name="primefile" id="primefile" value="'.$filedata['primefile'].'" />'.K_NEWLINE;
	...
	$onclick = 'FJ_insert_text(window.opener.document.getElementById(\''.$callingform.'\').'.$callingfield.', \'[object]\'+document.getElementById(\'primefile\').value+\'[/object:\'+document.getElementById(\'object_width\').value+\':\'+document.getElementById(\'object_height\').value+\':\'+document.getElementById(\'object_alt\').value+\']\');';
