<?php
//============================================================+
// File name   : prime_edit_subject.php
// Begin       : 2004-04-26
...
if ($subject_module_id <= 0) {
	...
	echo '<p><a href="prime_edit_module.php" title="'.$l['t_modules_editor'].'" class="xmlbutton">&lt; '.$l['t_modules_editor'].'</a></p>'.K_NEWLINE;
...
echo '<br />'.K_NEWLINE;
echo primecodeEditorTagButtons('form_subjecteditor', 'subject_description');
echo '</span>'.K_NEWLINE;
echo '</div>'.K_NEWLINE;
...
if ($subject_module_id > 0) {
	echo '<a href="prime_edit_module.php?module_id='.$subject_module_id.'" title="'.$l['t_modules_editor'].'" class="xmlbutton">&lt; '.$l['t_modules_editor'].'</a>';
}
...
if (isset($subject_id) AND ($subject_id > 0)) {
	echo '<a href="prime_edit_question.php?subject_module_id='.$subject_module_id.'&amp;question_subject_id='.$subject_id.'" title="'.$l['t_questions_editor'].'" class="xmlbutton">'.$l['t_questions_editor'].' &gt;</a>';
}
...
echo F_decode_primecode($subject_description);
