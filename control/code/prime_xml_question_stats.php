<?php
//============================================================+
// File name   : prime_xml_question_stats.php
// Begin       : 2010-05-10
...
require_once('../code/prime_functions_statistics.php');
require_once('../code/prime_functions_auth_sql.php');
...
if (isset($_REQUEST['testid']) AND ($_REQUEST['testid'] > 0)) {
	...
	$out_filename = 'primexam_questions_'.$test_id.'_'.date('YmdHis');
...
function F_xml_export_question_stats($test_id) {
	...
	$xml .= '<primexamquestionstats version="'.K_primexam_VERSION.'">'.K_NEWLINE;
	$xml .=  K_TAB.'<header';
	...
	$xml .= K_TAB.'</body>'.K_NEWLINE;
	$xml .= '</primexamquestionstats>'.K_NEWLINE;
