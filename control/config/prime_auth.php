...
/**
 * Required user's level to access "primecode editor".
 */
define ('K_AUTH_ADMIN_primeCODE', K_AUTH_OPERATOR);
...
/**
 * Required user's level to access "primexam information".
 */
define ('K_AUTH_ADMIN_INFO', 1);
