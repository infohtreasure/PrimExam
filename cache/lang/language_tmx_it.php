...
$tmx['d_admin_index']='Questa è l\'area di amministrazione di <a href="prime_page_info.php" title="informazioni su primexam">primexam</a>, un software accessibile, indipendente dalla piattaforma e dalla lingua, per la creazione e gestione online di test (esami).<br /><br />Attraverso il menù è possibile accedere alle varie sezioni del sistema:<ul><li><strong>utenti</strong><br />Questa sezione comprende le maschere per <a href="prime_edit_user.php" title="Gestione Utenti">inserire e modificare</a> gli utenti, per <a href="prime_select_users.php" title="Selezione Utenti">selezionarli</a> e per mostrare l\'elenco di quelli che sono attualmente <a href="prime_show_online_users.php" title="Utenti Online">collegati</a>.<br />Solo gli utenti registrati a cui è stata assegnata una user/password potranno accedere all\'area pubblica del sistema ed eseguire i test.<br />È possibile assegnare diversi livelli di accesso sia agli utenti che alle risorse (pagine, maschere, sezioni) del sistema.<br />primexam contiene un ulteriore sistema di sicurezza per l\'accesso ai test basato sul controllo degli indirizzi IP.</li><li><strong>moduli</strong><br />Questa sezione comprende le maschere per l\'inserimento e la modifica di <a href="prime_edit_module.php" title="Gestione Moduli">moduli</a>, <a href="prime_edit_subject.php" title="Gestione Argomenti">argomenti</a>, delle relative <a href="prime_edit_question.php" title="Gestione Domande">domande</a> e <a href="prime_edit_answer.php" title="Gestione Risposte Multiple">risposte</a>.<br />È possibile inserire un numero illimitato di argomenti che potranno essere arbitrariamente raggruppati per essere oggetto d\'esame in un test specifico. Sono illimitati anche i quesiti che si possono associare ad ogni argomento e le risposte alternative da associare ai quesiti a risposta multipla. Sarà cura del sistema scegliere casualmente le domande e le risposte tra tutte quelle disponibili.<br />primexam supporta sia domande a risposta multipla che a risposta aperta. Queste ultime andranno valutate attraverso un\'apposita maschera di <a href="prime_edit_rating.php" title="Valutazione risposte">valutazione</a>, mentre le altre verranno valutate automaticamente.<br />Le descrizioni dei test, degli argomenti, dei quesiti e delle risposte, supportano un particolare codice proprietario (primecode) che, con l\'ausilio di una apposita maschera, consente la formattazione del testo e l\'inserimento di immagini.</li><li><strong>test</strong><br />Questa sezione comprende la maschera per l\'inserimento, la generazione e la modifica dei <a href="prime_edit_test.php" title="Gestione Test">test</a>, la maschera per la <a href="prime_edit_rating.php" title="Valutazione risposte">valutazione</a> delle risposte aperte e le maschere per la visualizzazione o generazione di documenti PDF dei <a href="prime_show_result_allusers.php" title="Riepilogo risultati test">risultati</a>, del dettaglio dei compiti degli <a href="prime_show_result_user.php" title="Risultati test">utenti</a> e le <a href="prime_show_result_allusers.php" title="Statistiche sui quesiti">statistiche</a> sui quesiti impiegati nei test.<br />primexam provvede a selezionare casualmente i quesiti e le risposte in modo tale che per ogni utente venga generato un test unico.<br />È anche possibile generare un numero arbitrario di test in formato PDF affinché possano essere stampati su carta ed impiegati in un esame tradizionale.</li></ul>';
$tmx['d_logout_desc']='clicca sul pulsante per uscire dal sistema';
$tmx['d_primexam_desc']='primexam è un software per la gestione e l\'esecuzione e gestione di esami online.';
...
$tmx['h_guide']='guida di primexam';
$tmx['h_index']='pagina principale';
$tmx['h_info']='informazioni su primexam';
...
$tmx['h_primecode_editor']='editor che consente di aggiungere formattazione al testo usando un semplice codice proprietario';
...
$tmx['hp_edit_primecode']='Attraverso questa maschera è possibile aggiungere della formattazione e delle immagini al testo.';
...
$tmx['hp_login']='Per poter accedere alle varie sezioni di primexam è necessario autenticarsi inserendo il nome e la password che vi sono stati assegnati dall\'amministratore di sistema.';
...
$tmx['hp_public_index']='Questa è la pagina principale di primexam. Da questa pagina potete iniziare o continuare l\'esecuzione di uno dei test per i quali siete abilitati.';
...
$tmx['m_duplicate_passport']='questo codice fiscale è gia in uso, è necessario cambiarlo';
...
$tmx['t_page_guide']='primexam :: Guida';
$tmx['t_page_info']='Informazioni su primexam';
$tmx['t_public_index']='primexam :: Esecuzione Test';
...
$tmx['t_primecode_editor']='Formattazione testo';
...
Premendo il tasto [backup] il sistema crea una copia compressa del dump SQL dell\'intero database di primexam (struttura e dati).
...
I file di backup vengono registrati nella cartella "cache/backup" con la seguente sintassi: AAAAMMGGhhmmss_primexam_backup.sql.gz , dove AAAAMMGGhhmmss rappresenta le cifre dell\'anno (A), mese (M), giorno (G), ora (h), minuti (m), secondi (s).';
...
$tmx['m_otp_qrcode']='primexam utilizza un sistema di verifica a due fasi che richiede l\'inserimento di due diversi codici per accedere al sistema. Il primo codice è la password standard di primexam, il secondo è un codice generato dal tuo smartphone. Questo sistema previene l\'accesso al tuo account da coloro che conoscono solo la password o dispongono unicamente del tuo smartphone. Questo sistema richiede l\'utilizzo dello smartphone ogni qual volta si vuole accedere al proprio account primexam.<br /><br />Per utilizzare questo sistema è necessario scaricare ed installare sul proprio smartphone l\'applicazione <a href="https://support.google.com/a/bin/answer.py?hl=en&hlrm=en&answer=1037451">Google Authenticator</a>. Quando l\'applicazione è stata installata potete utilizzare il codice seguente o scansionare il QR-Code:';
