...
$tmx['d_admin_index']='To jest strefa administracyjna <a href="prime_page_info.php" title="o primexam">primexam</a>, jest środowiskiem programowym niezależnym od platformy i języka, przeznaczonym do tworzenia, zarządzania i przeprowadzania testów on-line.<br /><br />Z menu znajdującego się po lewej stronie możesz przenieść się do odpowiednich sekcji systemu:<ul><li><strong>użytkownicy</strong><br />Ta sekcja zawiera formularze do <a href="prime_edit_user.php" title="Zarządzanie użtkownikami">insert and manage</a> users, <a href="prime_select_users.php" title="User Selection"> to select them</a> and to show the list of the ones currently <a href="prime_show_online_users.php" title="Online Users">online</a>.<br />Just the registered users granted with a username and a password are entitled to access the public area of the system and perform the tests.<br />It is possible to specify different access levels for both the users and the different components and parts of the system (pages, forms, sections).<br />primexam utilizes also another security system to prevent unauthorized access based on the check of the IP addresses.</li><li><strong>modules</strong><br />This section contains the forms to insert and modify test <a href="prime_edit_module.php" title="Modules Management">modules</a>, <a href="prime_edit_subject.php" title="Topic Management">topics</a>, the related <a href="prime_edit_question.php" title="Question Management">questions</a> and <a href="prime_edit_answer.php" title="Multiple-Answer Management">answers</a>.<br />You can select an unlimited number of topics that can be used together for a specific test, and for each topic you can define an unlimited number of questions and possible answers. The system will randomly select questions and answers among the available ones.<br />primexam supports both multiple-answer questions and free-answer questions. The latters will be evaluated through a specific evaluation form <a href="prime_edit_rating.php" title="Answer evaluation"></a>, while the formers will be automatically evaluated.<br />All the descriptions of tests, topics, questions and answers support a particular proprietary code (primecode) that, by using a specific form, allows the use of images and text formatting.</li><li><strong>test</strong><br />This section includes the form to insert, generate and modify the different <a href="prime_edit_test.php" title="Test Management">tests</a>, the form to <a href="prime_edit_rating.php" title="Answer Evaluation">evaluate</a> the free answers and the forms to show or generate PDF versions of the <a href="prime_show_result_allusers.php" title="Test Results Summary">results</a>, a detailed view of the <a href="prime_show_result_user.php" title="Risultati test">users\' tests</a> and the <a href="prime_show_result_allusers.php" title="Question Statistics">statistics</a> of questions and answers utilized.<br />primexam selects on a random basis the various questions and related available answers so that all tests for the different users will be different from each other.<br />It is also possible to to generate an arbitrary number of tests in PDF format so that they can be printed and utilized for a conventional exam.</li></ul>';
$tmx['d_logout_desc']='kliknij na przycisk aby opościć system';
$tmx['d_primexam_desc']='primexam jest oprogramowaniem do zarządzania i przeprowadzania testów on-line.';
...
$tmx['h_primecode_editor']='editor that allows text formatting by using a simple proprietary code';
...
$tmx['hp_edit_primecode']='With this form you can add images and formatting to the text';
...
$tmx['hp_login']='Aby dostać się odpowiedniej sekcji primexam musisz zalogować się używając nazwy i hasła podanego przez administratora';
$tmx['hp_online_users']='This form shows the users currently logged';
$tmx['hp_public_index']='To jest główna strona primexam. Z taj strony możesz rozpocząć lub kontynuować twoje testy';
...
$tmx['m_duplicate_passport']='this passport has been already used, you must use another one';
...
$tmx['t_page_guide']='primexam :: Pomoc';
$tmx['t_page_info']='O primexam';
$tmx['t_public_index']='primexam :: Rozpoczęcie testu';
...
$tmx['t_primecode_editor']='Formatowanie tekstu';
...
$tmx['m_email_registration']='<?xml version="1.0" encoding="UTF-8"?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="pl" lang="pl" dir="ltr"><body><p>To jest automatyczna odpowedź wysłana aby zweryfikować <a href="#primeXAMURL#">primexam</a> Żądanie Rejestracji Nowego Użytkownika.<br />Request verification for email #EMAIL# submitted by remote IP #USERIP#.<br />If this message has been sent in error, please disregard.<br /><br /><b>TO CONFIRM THE REGISTRATION USE THE FOLLOWING LINK:<br /><a href="#SUBSCRIBEURL#">#SUBSCRIBEURL#</a></b></p></body></html>';
