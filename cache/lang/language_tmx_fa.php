...
$tmx['d_admin_index']='اینجا قسمت مدیریت <a href="prime_page_info.php" title="about primexam">primexam</a> میباشد. primexam نرم افزاری مستقل از زبان و سیستم عامل و دارای عملکردی کاربر پسند میباشد که توسط آن میتوان آزمون های آن لاین را اداره نموده و به انجام رساند.<br /><br />از طریق منو میتوانید به قسمت های مختلف سیستم دست بیابید:<ul><li><strong>کاربران</strong><br />در این قسمت فرمهائی برای <a href="prime_edit_user.php" title="User Management">ایجاد و اداره</a> کاربر, <a href="prime_select_users.php" title="User Selection"> انتخاب آنها</a> و برای نشان دادن لیستی از کاربرانی که هم اکنون  <a href="prime_show_online_users.php" title="Online Users">آن لاین</a>. هستند، وجود دارد.<br />تنها آن دسته از کاربرانی که ثبت نام شده و نام کاربری و گذرواژه دارند میتوانند وارد ناحیه عمومی سیستم شده و آزمونها را بگذرانند.<br />میتوان برای هر کاربر و یا هر قسمتی از سیستم (صفحات، فرم ها، قسمت ها)سطح دسترسی مشخصی تعریف کرد.<br />بعلاوه primexam سیستم امنیتی دیگری نیز برای جلوگیری از دستیابی غیرمجاز دارد که بر مبنای چک آدرس آی پی عمل میکند.</li><li><strong>ماژولها</strong><br />در این قسمت فرمهائی برای ایجاد و یا تغییر  <a href="prime_edit_module.php" title="Modules Management">ماژولهای</a> آزمون, <a href="prime_edit_subject.php" title="Topic Management">موضوعات</a>, <a href="prime_edit_question.php" title="Question Management">سؤالات</a> مربوطه و <a href="prime_edit_answer.php" title="Multiple-Answer Management">پاسخ</a> آنها وجود دارد.<br />میتوانید تعداد نامحدودی از موضوعات را انتخاب کرده و آنها را برای آزمون خاصی بکار برید. همچنین میتوانید برای هر موضوع تعداد نامحدودی سؤال همراه با جواب های آنها تعریف نمائید. با انتخاب گزینه سؤال یا پاسخ تصادفی, سیستم بطور تصادفی از بین سؤالات موجود و پاسخ های آنها برای آزمون انتخاب میکند.<br />primexam  سؤالات چندپاسخی و سؤالات تشریحی را نیز تولید میکند. البته پاسخ سؤالات تشریحی توسط فرم <a href="prime_edit_rating.php" title="Answer evaluation">ارزشیابی</a>  خاصی بررسی میگردند, اما انواع دیگر سؤالات بصورت خودکار توسط سیستم ارزیابی میشوند.<br />تمامی توضیحات مربوط به آزمونها, موضوعات, سؤالات و پاسخها از نوعی کدگذاری ویژه (primecode) برخوردارند  که, بکمک فرم خاصی میتوان برای آنها تصویر و پیکربندی متن تعریف کرد.</li><li><strong>آزمون</strong><br />در این قسمت فرمی برای ایجاد، تولید و تغییر <a href="prime_edit_test.php" title="Test Management">آزمونهای</a> مختلف, فرمی برای <a href="prime_edit_rating.php" title="Answer Evaluation">ارزشیابی</a> پاسخهای آزاد و فرمهائی برای نمایش و یا تولید نسخه پی دی اف <a href="prime_show_result_allusers.php" title="Test Results Summary">نتایج</a>, نمایش مفصل <a href="prime_show_result_user.php" title="Test Results">آزمونهای کاربران</a> و <a href="prime_show_result_allusers.php" title="Question Statistics">آماره های</a> سؤالات و پاسخهای بکاررفته وجود دارد.<br />با primexam میتوان بطور تصادفی سؤالات و پاسخ های آنها را  برای آزمون انتخاب نمود, بطوری که سؤالات کاربران با همدیگر تفاوت داشته باشد.<br />همجنین میتوان سؤالاتی را بصورت پی دی اف در آورد تا برای چاپ و امتحان کتبی سنتی بکار برد.</li></ul>';
$tmx['d_logout_desc']='با کلیک بر روی دکمه از سیستم خارج شوید';
$tmx['d_primexam_desc']='primexam نرم افزاری برای اداره و برگزاری آزمون آن لاین می باشد.';
...
$tmx['h_primecode_editor']='ادیتوری که به کمک یک کد ویژه، متن را پیکربندی میکند';
...
$tmx['hp_edit_primecode']='بکمک این فرم میتوانید تصاویری به متن اضافه کنید و یا متن را پیکر بندی نمائید';
...
$tmx['hp_login']='برای دسترسی به قسمت های مختلف primexam باید با استفاده از نام کاربری و گذرواژه ای که مدیر سیستم در اختیار شما گذاشته است وارد سیستم شوید';
$tmx['hp_online_users']='این فرم کاربرانی که درحال حاضر در سیستم هستند را نشان میدهد.';
$tmx['hp_public_index']='این صفحه اصلی primexam است. از اینجا میتوانید آزمون خود را شروع کرده و یا آزمونهای قبلی را ادامه دهید';
...
$tmx['m_duplicate_passport']='این شماره ملی قبلا ثبت شده است. باید شماره دیگری وارد کنید';
...
$tmx['t_page_guide']='primexam :: راهنما';
$tmx['t_page_info']='درباره primexam';
$tmx['t_public_index']='primexam :: برگزاری آزمون';
...
$tmx['t_primecode_editor']='ساختاربندی متن';
...
$tmx['m_email_registration']='<?xml version="1.0" encoding="UTF-8"?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fa" lang="fa" dir="rtl"><body><p>این یک پیام خودکار برای تایید درخواست ثبت نام کاربر جدید جهت <a href="#primeXAMURL#">primexam</a>.<br />تایید درخواست برای ایمیل #EMAIL# ارسال شده توسط آی پی #USERIP#.<br />اگر اشتباها برای شما ارسال شده است آن را نادیده بگیرید.<br /><br /><b>برای تایید ثبت نام از لینک زیر استفاده کنید:<br /><a href="#SUBSCRIBEURL#">#SUBSCRIBEURL#</a></b></p></body></html>';
...
YYYYMMDDhhmmss_primexam_backup.sql.gz
...
$tmx['m_otp_qrcode']='primexam از یک پورسه تایید هویت دومرحله ای استفاده میکند. برای دسترسی به سیستم شما باید دو چیز را وارد کنید.یکی گذرواژه استاندارد آزمون است و دیگری کد تایید   
