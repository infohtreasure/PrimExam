...
$tmx['d_admin_index']='Това е административната част на <a href="prime_page_info.php" title="относно primexam">primexam</a>, е платформа и същевременно интуитивен софтуер за създаване, управление и провеждане на он-лайн тестове.<br /><br /> От менюто вляво можете да достъпите различните секции на системата:<ul><li><strong>потребители</strong><br />Тази секция съдържа формите за <a href="prime_edit_user.php" title="Управление на потребители">въвеждане и управление</a> на потребители, <a href="prime_select_users.php" title="Избор на потребители"> за да ги избереш</a> и покажеш списък на текущите <a href="prime_show_online_users.php" title="Онлайн потребители">он-лайн потребители</a>.<br />Само регистрираните потребители имат потребителско име и парола, които им осигуряват достъп до публичните зони на системата и правото за провеждане на тестове.<br />Възможно е да се дефинират различни нива на достъп, както за потребителите, така и за различните компоненти и части на системата (страници, форми, секции).<br />primexam използва още една допълнителна система за сигурност за защита от неоторизиран достъп - основана на проверката на IP адреси.</li><li><strong>теми</strong><br />Тази секция съдържа формите за въвеждане и промяна на <a href="prime_edit_subject.php" title="Управление на теми">темите на теста</a>, свързаните с него <a href="prime_edit_question.php" title="Управление на въпроси">въпроси</a> и <a href="prime_edit_answer.php" title="Управление на отговори">отговори</a>.<br />Можете да изберете неограничен брой теми, които да се използват за даден тест, а също така можете за всяка тема да дефинирате неограничен брой въпроси и възможни отговори. Системата автоматично, на произволен принцип, ще избере въпросите, които са налични в момента.<br />primexam поддържа два вида тестове - тези със свободен отговор и тези от тип А Б В.  Последните се оценяват чрез специфична форма <a href="prime_edit_rating.php" title="Оценяване на отговори"></a>,докато тестовете с отворен отговор ще бъдат автоматично оценявани.<br />Всички видове тестове, теми, въпроси и отговори притежават собсвтен код (primecode), който чрез използването на специфична форма, позволява използването на снимки, графики и текстообработка.</li><li><strong>тест</strong><br />Тази секция включва начин на въвеждане, генериране и промяна на различните <a href="prime_edit_test.php" title="Управление на тестове">тестове</a>, начин за <a href="prime_edit_rating.php" title="Оценяване на отговори">оценяване</a> на свободните отговори и начините за представяне или генериране на PDF версии на <a href="prime_show_result_allusers.php" title="Обобщение на резултатите от тестовете">резултатите</a>, подробности за <a href="prime_show_result_user.php" title="Резултати на тестове направени от потребителите">тестовете направени от потребителите</a>, както и <a href="prime_show_result_allusers.php" title="Статистики на въпросите">статистики</a> на използваните въпроси и отговори.<br />primexam произволно избира изходна база от разнообразни въпроси, така че всички тестове за различните потребители  да се различават един от друг.<br />Освен това е възможно да се генерират произволен брой тестове в PDF формат, така че да могат да бъдат принтирани и използвани като за стандартен изпит.</li></ul>';
$tmx['d_logout_desc']='Кликни върху бутона, за да излезнеш от системата';
$tmx['d_primexam_desc']='primexam е софтуер за управление и провеждане на он-лайн тестове.';
...
$tmx['h_primecode_editor']='редактор, който позволява текстообработка чрез използване на прост личен код';
...
$tmx['hp_edit_primecode']='С тази форма можете да добавяте снимки и да обработвате текст.';
...
$tmx['hp_login']='За да достъпите различните секции на primexam първо трябва да се логнете с потребителското име и парола, които са ви дадени от системния администратор.';
$tmx['hp_online_users']='Тази форма показва потребителите, които в момента са логнати в системата';
$tmx['hp_public_index']='Това е главната страница на primexam. От тази страница можете да стартирате или продължите вашите тестове';
...
$tmx['m_duplicate_passport']='този номер на лична карта е зает, трябва да използвате друг';
...
$tmx['t_page_guide']='primexam :: Помощ';
$tmx['t_page_info']='Относно primexam';
$tmx['t_public_index']='primexam :: Изпълнение на теста';
...
$tmx['t_primecode_editor']='Текстообработка';
...
$tmx['m_email_registration']='<?xml version="1.0" encoding="UTF-8"?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="bg" lang="bg" dir="ltr"><body><p>Това е автоматичен отговор за потвърждение <a href="#primeXAMURL#">primexam</a> на заявката за регистрация на нов потребител.<br />Изисква потвърждение за е-мейл #EMAIL# потвърден от отдалечен IP #USERIP#.<br />Ако това съобщение генерира грешка при изпращането, моля не обръщайте внимание.<br /><br /><b>ЗА ДА ПОТВЪРДИТЕ РЕГИСТРАЦИЯТА ИЗПОЛЗВАЙТЕ СЛЕДНИЯ ЛИНК:<br /><a href="#SUBSCRIBEURL#">#SUBSCRIBEURL#</a></b></p></body></html>';
