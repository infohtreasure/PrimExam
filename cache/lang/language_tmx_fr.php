...
$tmx['d_admin_index']='C\'est la zone d\'administration <a href="prime_page_info.php" title="A propos de primexam">primexam</a>, un système indépendant de la plate-forme et de la langue, pour créer, gérer et effectuer des examens en
ligne.
...
primexam utilise également un autre système de sécurité pour empêcher l\'accès non autorisé, fondé sur une vérification des adresses IP.</li>
...
primexam supporte différents types de questions. Les réponses par la choix multiples et mettre  en ordre seront vérifié par la système, les réponses en texte libre doivent être évalués manuellement.<br />
Les descriptions des examens, des sujets, questions et réponses sont créés en utilisant un codage (primecode) qui permet également l\'utilisation de texte formaté ainsi que des images.</li>
...
$tmx['d_primexam_desc']='primexam est une application pour la gestion et l\'exécution de tests en ligne.';
...
$tmx['h_info']='à propos de primexam';
...
$tmx['h_primecode_editor']='éditeur de mise en forme du texte utilisant un code propriétaire simple';
...
$tmx['hp_edit_primecode']='Avec ce formulaire, vous pouvez ajouter des images et mettre en forme le texte';
...
$tmx['hp_login']='Pour accéder au "primexam", contactez l\'administrateur du système s.v.p.';
$tmx['hp_online_users']='Ce formulaire affiche les utilisateurs actuellement connectés';
$tmx['hp_public_index']='Vous êtes sur la page d\'accueil de primexam. Depuis cette page, vous pouvez commencer ou continuer vos examens.';
...
$tmx['m_duplicate_passport']='ce numéro de sécurité sociale a déjà été utilisé, vous devez en utiliser un autre';
...
$tmx['t_page_guide']='primexam :: Aide';
$tmx['t_page_info']='A propos de primexam';
$tmx['t_public_index']='primexam :: Exécution de test';
...
$tmx['t_primecode_editor']='Mise en forme du texte';
